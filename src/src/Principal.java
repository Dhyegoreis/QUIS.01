...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        perguntas[15] = new Principal();
        perguntas[15].pergunta = "Qual é o oposto de adição  ";
        perguntas[15].opcaoA = "adição";
        perguntas[15].opcaoB = "subtração";
        perguntas[15].opcaoC = "somatória";
        perguntas[15].opcaoD = "multiplicação";
        perguntas[15].opcaoE = "fração";
        perguntas[15].correta = "A";
